...
user-invocable: true
metadata: {"license":"MIT-0","version":"4.1.32","runtime":"zeroclaw","image":"ghcr.io/argonautsystems/ic-engine:4.1.32-cpu","mcp-endpoint":"http://localhost:18090/mcp"}
---
...
- `mnemos-os/ic-engine:4.1.32-cpu` → `localhost:18090`
