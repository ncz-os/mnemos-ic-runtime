...
user-invocable: true
metadata: {"license":"MIT-0","version":"4.1.39","runtime":"zeroclaw","image":"ghcr.io/argonautsystems/ic-engine:4.1.39-cpu","mcp-endpoint":"http://localhost:18090/mcp"}
---
...
- `mnemos-os/ic-engine:4.1.39-cpu` → `localhost:18090`
