...
user-invocable: true
metadata: {"license":"MIT-0","version":"4.1.32","runtime":"hermes","image":"ghcr.io/argonautsystems/ic-engine:4.1.32-cpu","mcp-endpoint":"http://localhost:18090/mcp"}
---
...
Docker compose (~/.investorclaw/compose.yml)
  ├── mnemos-os/ic-engine:4.1.32-cpu       :8090   portfolio analysis MCP
